		...
		describe(`Given a valid user`, () => {
			...
			it(`inserts 1 language with words for the new user`, () => {
				...
				const expectedList = {
					...
					total_score: 0,
					words: [
						{ translation: 'Orenji', original: 'Orange' },
						{ translation: 'Ki-iro', original: 'Yellow' },
						{ translation: 'Ao', original: 'Blue' },
						{ translation: 'Aka', original: 'Red' },
						{ translation: 'Midori', original: 'Green' },
						{ translation: 'Kuro', original: 'Black' },
						{ translation: 'Cha-iro', original: 'Brown' },
						{ translation: 'Pinku', original: 'Pink' },
						{
							translation: 'Murasaki',
							original: 'Purple',
						},
						{ translation: 'Shiro', original: 'White' },
						{ translation: 'Hai-iro', original: 'Gray' },
						{
							translation: 'Rairakku',
							original: 'Lilac',
						},
					],
				}
