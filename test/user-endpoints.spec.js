		...
		describe(`Given a valid user`, () => {
			...
			it(`inserts 1 language with words for the new user`, () => {
				...
				const expectedList = {
					...
					total_score: 0,
					words: [
						{ original: 'Oranji', translation: 'orange' },
						{ original: 'Ki-iro', translation: 'yellow' },
						{ original: 'Ao', translation: 'blue' },
						{ original: 'Aka', translation: 'red' },
						{ original: 'Midori', translation: 'green' },
						{ original: 'Kuro', translation: 'black' },
						{ original: 'Cha-iro', translation: 'brown' },
						{ original: 'Pinku', translation: 'pink' },
						{ original: 'Murasaki', translation: 'purple' },
						{ original: 'Shiro', translation: 'white' },
						{ original: 'Hai-iro', translation: 'gray' },
					],
				};
				return supertest(app)
					.post('/api/user')
